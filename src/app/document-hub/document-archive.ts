...
export const DOCUMENT_ARCHIVE: Record<SiteLanguage, PublishedDocument[]> = {
  en: [
    ...
    {
      id: 'test-council-agenda-march-2026',
      sectionId: 'meeting-documents',
      title: 'Test Council Agenda March 2026',
      summary: 'Benchmark test/MOC council agenda for town clerk workflow and code testing of the document hub and archive.',
      status: 'Test / MOC Benchmark',
      updatedAt: 'March 2026',
      format: 'HTML reference',
      href: '/documents/archive/test-council-agenda-march-2026.html',
      downloadFileName: 'test-council-agenda-march-2026.html',
      keywords: ['test', 'agenda', 'council', 'moc', 'benchmark', 'meeting', 'clerk'],
    },
    {
      id: 'mock-approved-minutes-february-2026',
      sectionId: 'meeting-documents',
      title: 'Mock Approved Minutes February 2026',
      summary: 'Sample mock minutes for benchmarking document hub, search, and clerk testing workflows.',
      status: 'Test / MOC Benchmark',
      updatedAt: 'March 2026',
      format: 'HTML reference',
      href: '/documents/archive/mock-approved-minutes-february-2026.html',
      downloadFileName: 'mock-approved-minutes-february-2026.html',
      keywords: ['mock', 'minutes', 'approved', 'test', 'benchmark', 'meeting'],
    },
  ],
  es: [
    {
