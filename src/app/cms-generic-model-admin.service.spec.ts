...
import { getAmplifyGraphqlMock } from '../testing/mock-amplify-graphql';
...
describe('CmsGenericModelAdminService', () => {
  ...
  let graphqlMock: ReturnType<typeof getAmplifyGraphqlMock>;
  let staffAuth: {
  ...
  beforeEach(() => {
    graphqlMock = getAmplifyGraphqlMock();
