...
const APP_COPY: Record<SiteLanguage, AppCopy> = {
  en: {
    ...
    searchLabel:
      'Try phrases like "pay water bill," "report pothole," or "next town meeting."',
    searchNote:
    ...
    transparencyHeading: 'Records, budgets, and notices must be easy to find and easy to understand',
    accessibilityKicker: 'Accessibility',
    accessibilityHeading: 'ADA and WCAG 2.1 AA work has to be visible in both design and operations',
    complianceNote:
    ...
    searchIndex: [
      {
        ...
        category: 'Weather',
        href: '#weather',
        keywords: ['weather', 'forecast', 'alerts', 'warning', 'watch', 'advisory', 'wind', 'snow', 'temperature', 'weather.gov', 'nws'],
      },
      {
        title: 'Pay utility bill',
        summary:
      ...
      },
      {
        ...
        category: 'Meetings',
        href: '#calendar',
        keywords: ['city council', 'regular meeting', '2nd monday', 'second monday', '6:00 pm', 'agenda', 'wiley town hall'],
      },
      {
  ...
  es: {
    ...
    meetingsHeading: 'El acceso a reuniones y al calendario comunitario debe estar en la pagina principal',
    ...
    servicesHeading: 'Las herramientas de autoservicio deben reducir llamadas a la oficina, no crear mas friccion',
    transparencyKicker: 'Transparencia',
    transparencyHeading: 'Los registros, presupuestos y avisos deben ser faciles de encontrar y faciles de entender',
    accessibilityKicker: 'Accesibilidad',
    accessibilityHeading: 'El trabajo de ADA y WCAG 2.1 AA debe verse tanto en el diseno como en la operacion',
    complianceNote:
    ...
    searchIndex: [
      {
        ...
        category: 'Clima',
        href: '#weather',
        keywords: ['clima', 'pronostico', 'alertas', 'advertencia', 'vigilancia', 'aviso', 'viento', 'nieve', 'temperatura', 'weather.gov', 'nws'],
      },
      {
        title: 'Pagar recibo de servicios',
        summary:
      ...
      },
      {
        ...
        category: 'Reuniones',
        href: '#calendar',
        keywords: ['concejo municipal', 'reunion', 'segundo lunes', 'agenda', 'ayuntamiento de wiley'],
      },
      {
        title: 'Encontrar la proxima reunion del pueblo',
        summary: 'Vaya al horario del concejo, la orientacion sobre agendas y la seccion del calendario.',
        category: 'Reuniones',
        href: '#alerts',
      ...
      },
      {
        ...
        category: 'Calendario',
        href: '#calendar',
        keywords: ['calendario', 'eventos', 'horario', 'fechas limite', 'audiencia', 'google calendar', 'ics', 'concejo'],
      },
      {
        title: 'Solicitar registros publicos',
        summary: 'Localice formularios FOIA, orientacion sobre registros y expectativas de respuesta.',
        category: 'Transparencia',
        href: '#records',
        keywords: ['foia', 'registros', 'registros publicos', 'documentos', 'minutas', 'presupuesto'],
      },
      {
      ...
      },
      {
        ...
        category: 'Contacto',
        href: '#contact',
        keywords: ['contacto', 'telefono', 'ayuntamiento', 'secretaria', 'permisos', 'wiley', '719 829 4974', 'deb dillon', 'scott whitman', 'stephen mckitrick', 'steve mckitrick', 'julie esgar'],
      },
    ],
  },
};
