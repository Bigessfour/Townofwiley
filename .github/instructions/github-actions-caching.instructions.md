...
3. **Ollama:** default model on hosted runners is `llama3.2:3b`; override via repo variables `OLLAMA_CI_MODEL` / `OLLAMA_PR_REVIEW_MODEL`. Full guide: [`docs/ci-ollama-review.md`](../../docs/ci-ollama-review.md).
