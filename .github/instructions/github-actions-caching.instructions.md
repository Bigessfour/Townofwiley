...
| Ollama model weights | `./.github/actions/setup-ollama` (wraps `cache-ollama-model`) | Ollama CI diagnosis |
...
3. **Ollama:** CI triage default on hosted runners is `llama3.2:3b`. Override via repo variable `OLLAMA_CI_MODEL`. Full guide: [`docs/ci-ollama-review.md`](../../docs/ci-ollama-review.md).
