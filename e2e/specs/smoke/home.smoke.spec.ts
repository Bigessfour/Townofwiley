...
test.describe('homepage smoke', () => {
  ...
  test('keeps the hero quick actions wired to resident tasks', async ({ homePage }) => {
    ...
    const heroActions = homePage.page.locator('.hero-utility-actions .button-cta');
    const heroActionGroup = homePage.page.locator('.hero-utility-actions');
  ...
  test('opens the remaining public feature pages from the homepage', async ({ homePage }) => {
    ...
    await homePage.page.locator('.feature-grid .feature-card[href="/services"]').click();
    ...
    await homePage.page.locator('.feature-grid .feature-card[href="/contact"]').click();
