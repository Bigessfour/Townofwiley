...
| Manage email forwarding               | EmailAlias            | Retired (Synology MX)                                  | n/a                                                                                                                                                                                                             | n/a                                                                                                   | retired                                                   |
...
- **Email forwarding end-to-end (retired)** (SES/mail-router sync after `EmailAlias` save) — out of scope; UI and persistence layers reviewed only.
