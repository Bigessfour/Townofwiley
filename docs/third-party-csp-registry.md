...
| Lambda Function URLs       | `connect-src`                                       | `https://*.lambda-url.us-east-2.on.aws`                                                                 | NWS proxy, severe-weather signup, community calendar, contact write | Per feature                     |
...
| ~~Easy-Peasy AI~~ (decommissioned June 2026) | — | — | Chatbot removed; `runtime-config` `chatbot.mode: none` | Removed from `customHttp.yml` |
