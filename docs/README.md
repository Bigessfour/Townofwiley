...
| Hosting / DNS / CSP source of truth             | [`OPERATIONS.md`](OPERATIONS.md) (S3+CloudFront section) + [`AWS_INFRASTRUCTURE_SOT.md`](AWS_INFRASTRUCTURE_SOT.md) (historical Amplify details in [`AMPLIFY_HOSTING_SOT.md`](AMPLIFY_HOSTING_SOT.md) — deprecated) |
