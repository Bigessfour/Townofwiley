...
| ------------------------------------------------------------------------------ | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Post news or notice** (`post-notice`)                                        | `Announcement`                                         | [`cms-clerk-record-editor.component.html`](../src/app/cms-admin/cms-clerk-record-editor.component.html) (generic) | `/news` (legacy `/notices` redirects here)                        | `notice-{sanitized id}` on `<a class="notice-card">` ([`news.html`](../src/app/news/news.html)); `town-newsletter-heading` on `<h2>` ([`news.html`](../src/app/news/news.html)) | Newsletter → `https://townofwiley.gov/news#town-newsletter-heading`. Short notice → `https://townofwiley.gov/news#notice-{sanitized savedId}` | `https://townofwiley.gov/news#recent-town-notices-heading`      | The card with your title is in view; date and detail match the form.                                                     |
...
| Test file                                                                                       | What it proves                                                                   | What it does _not_ prove                                 |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------- |
