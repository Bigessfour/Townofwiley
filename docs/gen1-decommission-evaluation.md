...
**Do not delete Gen 1 yet.** Production **public CMS** already reads **Gen 2 AppSync**, but several Gen 1 resources are still required or need a verified cutover step.
