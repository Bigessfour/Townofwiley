...
echo "  - Retries: transient 408/429/5xx and network errors use exponential backoff + jitter; 429 honors Retry-After (capped). Optional env: NWS_RETRY_MAX_ATTEMPTS, NWS_RETRY_BASE_MS, NWS_RETRY_MAX_DELAY_MS."
